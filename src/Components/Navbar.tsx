...
const Navbar = () => {
  return (
    <nav className="fixed z-50 bottom-2 left-1/2 w-[95%] -translate-x-1/2 h-16 flex items-center justify-center gap-8 p-4 rounded-full bg-[#FAF9FE] text-[#B1B5C8] stroke-[#B1B5C8]">
